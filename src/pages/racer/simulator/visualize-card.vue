...
import type { Result } from './progress-bar.vue'
import AnalysisProgress from './progress-bar.vue'

import Feeling from './tab-feeling.vue'
import Efficient from './tab-efficient.vue'
